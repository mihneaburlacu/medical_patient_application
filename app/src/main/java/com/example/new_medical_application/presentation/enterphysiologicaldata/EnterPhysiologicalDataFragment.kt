package com.example.new_medical_application.presentation.enterphysiologicaldata
...
@AndroidEntryPoint
class EnterPhysiologicalDataFragment: Fragment() {
    private var _binding: FragmentPhysiologicalDataBinding? = null
    private val binding get() = _binding!!
    private val viewModel: EnterPhysiologicalDataViewModel by viewModels()
